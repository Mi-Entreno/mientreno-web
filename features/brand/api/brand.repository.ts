...
export const brandRepository = {
  ...
  /**
   * The merchant's work queue. Upstream orders it oldest-first when filtered by
   * status: what has waited longest gets handed over first.
   */
  async redemptions(
  ...
  /** Cancelling needs a reason upstream: it refunds the reps and the stock. */
